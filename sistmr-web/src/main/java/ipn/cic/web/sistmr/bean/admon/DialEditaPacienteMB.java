 ...
 * @author J.Perez
 */
@Named(value="dialEditaPacienteMB")
@ViewScoped
public class DialEditaPacienteMB implements Serializable{

    private static final long serialVersionUID = 1L;
    private static final Logger logger = Logger.getLogger(DialEditaPacienteMB.class.getName());
