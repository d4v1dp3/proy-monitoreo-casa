...
VALUES (123456,(SELECT ID_PERSONA FROM RM_PERSONA WHERE CURP = 'ALMM490617HSPDSS05'), 'cuenta1notificaciones@gmail.com',55555555555);
...
INSERT INTO RM_USUARIO (ID_USUARIO, CONTRASENIA, ACTIVO, ID_PERSONA)
VALUES ('medico1','medico1',1,(SELECT ID_PERSONA FROM RM_PERSONA WHERE CURP = 'ALMM490617HSPDSS05'));
